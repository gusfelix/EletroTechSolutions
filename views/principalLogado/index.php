...
$nome = $cliente->getInfo($_SESSION['idcliente'])['nomec'];
...
<body>
  ...
  <main id="mainMenu" onclick="barraLateral()" >
    <section id="secMenu">
    <article id="artPopUp">
      <section id="imgPopUp"><h4><?= strtoupper(mb_substr($nome, 0, 1))?></h4></section>
      <h4><?= $primeiroNome ?></h4>
      <h4> <?= $planoStr ?></h4>
    </article>
      <a href="../meuPerfil/"><h4>Meu perfil</h4></a>
      <a href="../meusAgendamentos/"><h4>Agendamentos</h4></a>
      <a href="../../controller/ClienteController.php?logout=true"><h4>Sair</h4></a>
    </section>
    ...
    <div class="nav-container">
      ...
      <nav>
        <ul class="nav-container-navbar">
          ...
          <li>
            <!-- pop Up -->
            <section id="perfil" onclick="popUpUser()"></section>
            <section id="popUp">
              ...
              <article id="artTextPopUp">
                <section id="links">
                  <a href="../meuPerfil/"><i class="fa-solid fa-id-card-clip"></i><p>Meu perfil</p></a>
                  <a href="../meusAgendamentos/"><i class="fa-solid fa-calendar-days"></i><p>Meus agendamentos</p></a>
                  <a href="../../controller/ClienteController.php?logout=true"><i class="fa-solid fa-right-from-bracket"></i><p>Sair</p></a>
                </section>
              </article>
            </section>
          </li>
      ...
      <i class="fas fa-bars" onclick="barraLateral()"></i>
    </div>
    <div class="title-container" onclick="exitPopUpUser()">
      <h2>EletroTech Solutions</h2>
      <h1>Experiência no Mercado</h1>
      <a href="#" id="link-agenda" class="btn btn-primary btn-rounded">Realizar Agendamento</a>
    </div>
  </header>
  ...
  if($plano == NULL){
    echo ' <main class="services-container">
    <h2>Nossos planos</h2>
    <div class="services-card-container">
      <div class="services-card radius">
        ...
        <br><br>
        <a href="../cartao/?plano=MENSAL" class="btn btn-primary marginTop">CONTRATAR</a>
      </div>
      <div class="services-card radius shadow">
        ...
        <br><br>
        <a href="../cartao/?plano=ANUAL" class="btn btn-primary marginTop">CONTRATAR</a>
      </div>
      <div class="services-card radius">
        <section class="iconCusto2"></section>
        ...
        <br><br>
        <a href="../cartao/?plano=SEMESTRAL" class="btn btn-primary marginTop">CONTRATAR</a>
      </div>
    </div>
  </main>';
  }
